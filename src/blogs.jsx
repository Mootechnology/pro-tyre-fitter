...
function BlogPage() {
  ...
  return (
    <div>
      <Helmet>
        <title id="meta-title">
          Car Care Insights: Top Tips & Advice for Vehicle Owners
        </title>
        <meta
          name="description"
          id="meta-description"
      ...
      <div className="mt-4">
        ...
        <div className="para-width mx-auto">
          <p>
            ...
            fermentum justo. Vestibulum feugiat vehicula elit, at congue orci
            venenatis nec. Morbi hendrerit mauris vel arcu hendrerit, nec
            tristique purus auctor. Nullam euismod nunc nec dictum tempus.
            Integer malesuada felis vel justo aliquet, a tincidunt arcu
            vulputate. Quisque suscipit, ligula eu pharetra scelerisque, tortor
            ligula aliquam felis.
          </p>
        </div>
      </div>
      ...
      <div className="mt-4" style={{ marginBottom: "-50px" }}>
        ...
        <div className="para-width mx-auto text-center">
          <p>
            ...
            <Col md={6}>
              <div className="mt-3">
                ...
                <div className="d-flex justify-content-center">
                  <Link to={`/blog/${post.id}`} className="btn btn-success">
                    Read More
                  </Link>
                </div>
              </div>
